...
public:
    ...
    KDEProducer(const std::vector<double> * xvals, const std::vector<double> * weights, const double hSF,
            const unsigned int nXBins, const double xMin, const double xMax, const double trimFactor,const bool doSigmaScaling
    );
    ...
    //Non adaptive pdf
    TH1 * getPDF(const std::string& name, const std::string& title, const unsigned int nBins, const float xMin, const float xMax) const;
    //adaptive pdf
    TH1 * getAPDF(const std::string& name, const std::string& title, const unsigned int nBins, const float xMin, const float xMax) const;
    ...
    TH1 * getABandwidths(const std::string& name, const std::string& title, const unsigned int nBins, const float xMin, const float xMax) const;
    //Get local variance histogram
    TH1 * getLocalVariance(const std::string& name, const std::string& title, const unsigned int nBins, const float xMin, const float xMax) const;
private:
